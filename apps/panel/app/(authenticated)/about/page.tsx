...
const members: Member[] = [
  ...
  },
  {
    ...
    badge: "A2",
    name: "能登 啓晶",
    image: "https://github.com/notokeisho.png",
    github: "https://github.com/notokeisho",
    delay: 0.1,
  },
  {
    role: "バックエンド・フロントエンド開発者",
    ...
    github: "https://github.com/ReTic0310",
          ...
          >
            <Grid container spacing={1.5}>
                ...
                >
                  ...
                  >
                    <CardContent sx={{ height: "100%" }}>
                      ...
                      >
                        <Typography align={"center"} fontSize={"16px"}>
                          The 16th NAPROCK INTERNATIONAL PROGRAMMING CONTEST
                        </Typography>
                        <Stack
                          direction={"row"}
                          justifyContent={"center"}
              ...
              <Stack
                ...
                sx={{ width: "100%" }}
              >
                <Typography fontSize={"20px"}>SPORTSDAYの開発</Typography>
              </Stack>
                  ...
                  <Card sx={{ width: "100%", mt: 1 }}>
                    ...
                    <CardContent sx={{ width: "100%" }}>
                      <Stack
                        ...
                        spacing={1}
                      >
                        <Typography>SPORTSDAY導入前後のワークフロー</Typography>
                      </Stack>
                    </CardContent>
                  </Card>
                </motion.div>
                ...
                <Card sx={{ width: "100%", mb: 10, mt: 1 }}>
                  ...
                  <CardContent sx={{ width: "100%" }}>
                    <Stack
                      ...
                      spacing={1}
                    >
                      <Typography>SPORTSDAYの各アプリケーション関係</Typography>
                    </Stack>
                  </CardContent>
                </Card>
              </motion.div>
