...
func main() {
	...
	promotionRuleRepository := repository.NewPromotionRule()
	// service
	...
	promotionService := service.NewPromotion(db, promotionRuleRepository, competitionRepository, matchRepository, leagueRepository, rankingRuleRepository)
