...
type League interface {
	...
	ListTiebreakPriorities(ctx context.Context, db *gorm.DB, leagueID string) ([]*db_model.TiebreakPriority, error)
	SetTiebreakPriorities(ctx context.Context, db *gorm.DB, leagueID string, priorities []*db_model.TiebreakPriority) ([]*db_model.TiebreakPriority, error)
}
